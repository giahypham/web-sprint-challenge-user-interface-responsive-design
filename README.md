...
* [ ] Create social media buttons on header for Facebook, Twitter, and Instagram with icons from [FontAwesome](https:/f/fontawesome.com/search). *NOTE: * ENSURE that the icon name includes "facebook", "twitter", or "instagram" respectively.
